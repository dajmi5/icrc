...
class TestProductOperatingUnit(common.TransactionCase):
    def setUp(self):
        ...
        # Products
        self.contact1 = self.env.ref("product.product_product_1_product_template")
        self.contact2 = self.env.ref("product.product_product_9_product_template")
        self.contact3 = self.env.ref("product.product_product_11_product_template")
        # Create users
